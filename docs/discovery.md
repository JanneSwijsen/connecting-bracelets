...
Om op deze vragen antwoorden te krijgen, zijn we fysieke prototypes maken. Deze zullen we vervolgens in een user test gaan voorleggen aan onze doelgroep.
