...
| 1.2 | Het product laat toe via externe tactiele knoppen speelfuncties te bevatten. | Interview | ⚠️ |
| 1.3 | Het product laat toe de vereiste handelingen uit te laten voeren door verschillende types blindheid. | Interview | ❌ |
| 1.4 | De producten laten toe elk een unieke kleur te hebben. |  | ❌ |
| 1.5 | De producten laten toe deze kleuren goed te onderscheiden door de gebruikers. |  | ❌ |
...
| **Navigatie** |
| 2.1 | Het product laat toe duidelijke signalen te geven in de vorm van haptische feedback. | Concept Testing | ✅ |r de weg leiden. |  | ❌ |
| 2.2| Het product laat toe deze trillingen op een constante manier over te dragen aan de gebruiker. | Concept Testing | ✅ |
| 2.3 | Het product laat doe deze trillingen op een aangenaam ritme over te dragen aan de gebruiker.
